...
description: "How MITRE ATT&CK is used to map red-team playbooks. Mapping a technique is not a claim that every technique in the matrix ran."
...
- **Mapped ATT&CK techniques**: reports should show which mapped checks ran — mapping is not full-matrix coverage
